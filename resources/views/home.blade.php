                            ...
                            <div class="col-lg-12">
                                <section class='tabs-content'>
                                    <form action="{{ url('/addtestimony') }}" method="POST"
                                        ...
                                        <textarea name="comment" placeholder="{{ __('Testimony') }}" placeholder="name"
                                            class="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"></textarea>


                                        <div class="pb-10 pt-2">
                                            <button
                                                class="bg-orange-300 hover:bg-yellow-700 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow justify-items-center"><input
